                                               ...
                                               <div class="row">
                                                   <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                       <div class="form-group label-floating">
                                                           ...
                                                           <select class="form-control select2" style="width: 100%;"  name="products[][id]" id="product">
                                                   ...
                                                   <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                       <div class="form-group label-floating">
                                                           ...
                                                           <input type="number" class="form-control" name="products[][quantity]" id="quantity" value="0">
                                                       </div>
                                                   </div>
                                                   <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                       <div class="form-group label-floating">
                                                           <label class="control-label">Price <strong style="color:red;">(*)</strong></label>
                                                           <input type="number" class="form-control" name="products[][price]" id="price" readonly>
                                                       </div>
                                                   </div>
                                                   <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                       <div class="form-group label-floating">
    ...
    $(document).ready(function() {
        ...
        addProductButton.on('click', function() {
            ...
            if (productId && quantity > 0 && price > 0) {
                let newRow = `
                    <tr>
                        <td><input type="hidden" name="products[][id]" value="${productId}">${productName}</td>
                        <td><input type="hidden" name="products[][quantity]" value="${quantity}">${quantity}</td>
                        <td><input type="hidden" name="products[][price]" value="${price}">${price.toFixed(2)}</td>
